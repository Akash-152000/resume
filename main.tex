...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeEducationHeading
      ...
      {Bachelor of Engineering in Information Technology;   \textbf{CGPA: 7/10.00}}{Aug 2017 \textbf{--} Jun 2021}
...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        \textbf{Programming:}{JavaScript,HTML/CSS, C/C++, Git,  } \\ \vspace{3pt}
        
        \textbf{Frontend:}{ ReactJs, HTML/CSS, Tailwind CSS, Bootstrap, WordPress} \\ \vspace{3pt}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Systems Engineer}{Sep 2021 \textbf{--} Aug 2023}
        \resumeItemListStart
            ...
            \resumeItem{Trained on MS-Azure, SSIS and Big Data.}
        \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      {Web Developer}{Feb 2023 \textbf{--} June 2023, Freelance}
        \resumeItemListStart
            \resumeItem{Underwent Design Process and developed the \textbf{100\% of the landing page} of the company.}
            \resumeItem{Designed each section of the website using \textbf{HTML}, \textbf{CSS} and \textbf{JavaScript} using the Company provided data. Integrated WP-Forms for sending information through contact form.}
            \resumeItem{Maintained the website \textbf{completly responsive} for all the devices. \textbf{Deployed the website using cPanel of Godaddy}. Added \textbf{SSL certificate} to the website }
        \resumeItemListEnd
    
    \resumeSubheading
      {INCK Foundation}{Dombivali, Maharashtra}
      {WordPress Developer}{June 2023 \textbf{--} Sept 2023, Freelance}
        \resumeItemListStart
            \resumeItem{Implemented the Website using \textbf{WordPress CMS and CSS}} designed 9 pages for the website including Donation page. Added Contact form, Doantion Form, Volunteer Form.
            \resumeItem{\textbf{Integrated Instamojo} as means for taking donations. Created donation campaigns for getting donations for varoius campaigns like Food For All, Digital Literacy for Special Kids, Women Empowerment and Medical Equipment Support.}
        \resumeItemListEnd
    ...
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
        {\textbf{BlueOrb} $|$ \emph{\href{https://blueorb.in}{\color{blue} blueorb.in}} $|$ \emph{\href{https://github.com/Akash-152000/BlueOrb}{\color{blue}GitHub}}}{}
          \resumeItemListStart
            \resumeItem{\textbf{Project uses three.js, ReactJs and tailwind css} for frontend. Was intialized by \emph{\href{https://github.com/joelj7011}{\color{blue}Shivang Tiwari}} and I joined in as a contributor.}
            \resumeItem{Improved the \textbf{website speed by 35\% by lazy loading}  3D models and website images. Made the Website Mobile Responsive. Identified bugs and resolved them.}
            \resumeItem{\textbf{Deployed} the website on \textbf{netlify} and pointed it to the \textbf{domain name}. Using BlueOrb to showcase my Portfolio by adding my Projects on the Website.}
          \resumeItemListEnd
